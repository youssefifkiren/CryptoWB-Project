        ...
        <div className="flex w-full justify-center items-center">
            <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col md:mr-10">
                    ...
                    <p className="text-left text-white mt-5 font-light w-9/12 w-11/12 text-base">explorez le monde de la cryptographie, achetez et vendez facilement Crypto avec cryptoWB</p>
                    <button
                    type="button"
                    onClick={ConnectMeta}
